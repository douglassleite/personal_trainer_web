    ...
    <div class="pt-24 pb-20 px-6">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
          ...
          <h1 class="text-3xl font-black text-gray-900 dark:text-white">Captação de Alunos</h1>
          <p class="text-gray-600 dark:text-gray-400 mt-1">Gerencie seus leads e novos alunos</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-12 text-center">
          <div class="w-24 h-24 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center mx-auto mb-6">
            <Icon name="lucide:user-plus" class="w-12 h-12 text-orange-600 dark:text-orange-400" />
          </div>
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Em Desenvolvimento</h2>
          <p class="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
            Esta funcionalidade está sendo desenvolvida. Em breve você poderá gerenciar seus leads, criar links de captação e converter novos alunos.
          </p>
        </div>
      </div>
    </div>
...
useHead({
  title: 'Captação - Academia na Mão',
  meta: [
    { name: 'description', content: 'Gerencie seus leads e captação de alunos' }
  ]
})
</script>
